...
namespace DSimulator
{
    public class Comservice
    {
        ...
        public void Start()
        {
            ...
            string fileName = "i://tt.txt";// Path.Combine(Directory.GetCurrentDirectory(), "UploadTest.exe");
        ...
        protected bool SendFile(string fileName, ClientUploadSocket uploadSocket)
        {
